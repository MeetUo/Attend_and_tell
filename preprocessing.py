...
def main():
    ...
    val_dataset = _process_caption_data(caption_file=caption_file,
    ...
    # cancel the val_data because there are bugs about bleu score in python3 and I haven't fix it
    ...
    save_pickle(val_dataset.reset_index(drop=True), 'data/test/test.annotations.pkl')
